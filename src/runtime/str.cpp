...
void setupStr() {
    ...
    str_cls->giveAttr("ljust", new BoxedFunction(boxRTFunction((void*)strLjust, UNKNOWN, 3)));
    str_cls->giveAttr("rjust", new BoxedFunction(boxRTFunction((void*)strRjust, UNKNOWN, 3)));
    str_cls->giveAttr("center", new BoxedFunction(boxRTFunction((void*)strCenter, UNKNOWN, 3)));
